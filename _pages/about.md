...
1. [A Uniform Construction of Cohomology Theories of Varieties via Fundamental Groupoids](https://arxiv.org/abs/2602.12718), preprint (formerly titled *Pro-Algebraic Site*).
1. [Computing Picard Schemes](https://arxiv.org/abs/2601.16505) (with Madhavan Venkatesh), submitted.
1. [Bounds on Torsion in Cohomology and an Effective Version of Deligne's Gcd Theorem](https://arxiv.org/abs/2511.00431) (with Madhavan Venkatesh), to appear in *Journal de Théorie des Nombres de Bordeaux*.
1. [Maximum Overlap Area of Several Convex Polygons Under Translation](https://arxiv.org/abs/2301.02949) (with Honglin Zhu), 36th Canadian Conference on Computational Geometry (CCCG 2024).
